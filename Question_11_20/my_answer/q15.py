...
def main():
    ...
    k_vertical = np.array([[1, 2, 1], [0, 0, 0], [-1, -2, -1]])
    k_horizontal = np.rot90(k_vertical)
    Ix = my_convolve(gray, k_horizontal)
    Iy = my_convolve(gray, k_vertical)
    plt.imshow(Ix, cmap='gray')
    plt.imshow(Iy, cmap='gray')
    plt.imsave('/home/haochen/Projects/ImageProcessing100Wen/Question_11_20/my_output/15_sobel_ix.png', Ix, cmap='gray')
    plt.imsave('/home/haochen/Projects/ImageProcessing100Wen/Question_11_20/my_output/15_sobel_iy.png', Iy, cmap='gray')
    plt.show()
